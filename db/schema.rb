...
ActiveRecord::Schema[7.0].define(version: 2024_11_28_010834) do
  ...
  create_table "financial_infos", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["proponent_id"], name: "index_financial_infos_on_proponent_id"
  end
  ...
  add_foreign_key "financial_infos", "proponents"
